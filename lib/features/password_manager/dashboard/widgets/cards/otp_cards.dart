...
/// Карточка TOTP для режима списка
  ...
  void _generateCode() {
    ...
    try {
      ...
      final code = OTP.generateTOTPCodeString(
        ...
        algorithm: Algorithm
            .SHA1, // TODO: использовать algorithm из OtpCardDto если будет добавлен
      );
    ...
    return Stack(
      children: [
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          Text(
                            'Использован: ${widget.otp.usedCount} раз',
                            style: theme.textTheme.bodySmall?.copyWith(
                              color: Colors.grey,
                              fontSize: 11,
                            ),
                          ...
                          Text(
                            'Изменён: ${_formatDate(widget.otp.modifiedAt)}',
                            style: theme.textTheme.bodySmall?.copyWith(
                              color: Colors.grey,
                              fontSize: 11,
                            ),
        ...
        if (widget.otp.isArchived)
          Positioned(
            top: 2,
            left: widget.otp.isPinned || widget.otp.isFavorite
                ? (widget.otp.isFavorite ? 60 : 34)
                : 8,
            child: Transform.rotate(
              angle: -0.52,
              child: const Icon(
